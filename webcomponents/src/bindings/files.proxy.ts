...
import {FILES_DEFAULT_INTEGRITY_ZOME_NAME, FILES_DEFAULT_COORDINATOR_ZOME_NAME, FILES_DEFAULT_ROLE_NAME, FILE_TYPE_NAME, ATTACHMENTS_ROOT, FileShareEntry, FileShareLinkTypes, AttachInput, WriteManifestInput, SendFileInput, FileShare, } from './files.types';
import {
/** types.ts */
HoloHash,
AgentPubKey,
