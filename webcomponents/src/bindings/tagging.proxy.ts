...
// @ts-ignore
import {PUBLIC_TAG_ROOT, TAGGING_DEFAULT_COORDINATOR_ZOME_NAME, TAGGING_DEFAULT_INTEGRITY_ZOME_NAME, TaggingEntry, PrivateTag, TaggingInput, TaggingProperties, UntagInput, } from './tagging.types';
// @ts-ignore
import {
/** api/common.ts */
// @ts-ignore
